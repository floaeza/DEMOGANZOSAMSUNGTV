 ...
 *******************************************************************************/
    ...
    function SetDate(){
        ...
        // FormatDateAndHour = moment().subtract(3, 'hours').format('MMM, DD / h:mm A');
        // CurrentStbDate = moment().subtract(3, 'hours').format('Y-MM-DD h:mm:ss');
        ...
        if(!Device){
            if (Device.Client === 'CHL') {
                FormatHour = moment().subtract(3, 'hours').format('h:mm A');
            } else {
                FormatHour = moment().subtract(3, 'hours').format('MMMM Do h:mm a');
            }
        } else {
            //  FormatHour = moment().subtract(2, 'hours').format('h:mm A');
        ...
        } else if(CurrentModule === 'Menu' || CurrentModule === 'Tv'){
        ...
        Debug('-------------------------------- FormatDateAndHour: '+FormatDate);

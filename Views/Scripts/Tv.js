    ...
    if(ActiveEpgContainer === false){
        ...
        /* Regresamos a su valor inicial la variable DIRECTION*/
            ...
            if(ChannelsJson[ChannelPosition].STTN !== 'CONTENT'){
                ...
                cleanVideoImage();
                Debug('--------------------->'+ChannelsJson[ChannelPosition].INDC);
                if (ChannelsJson[ChannelPosition].INDC === 'Promo'){
                    moduleToPlayVideos = 'promo';
                    newDigitalChannel();
                }else if (ChannelsJson[ChannelPosition].INDC === 'Clima'){
                    weatherChannel();
                }else if (ChannelsJson[ChannelPosition].INDC === 'RH'){
                    console.log(moduleToPlayVideos);
                    moduleToPlayVideos = 'rh';
                    newDigitalChannel();
                    MenuDateRH.style.display = 'none';
                    MenuHourRH.style.display = 'none';
                    getInfoToRH();
                }
            }

...
var videosRHListServer    = getInfoFromServer('getVideosModuleRH'),
    videosRHListLenght    = (videosRHListServer.length)-1,
    multimediaRHPosition  = 0;
    ...
    onstreamcompleted: function() {
        ...
        if(CurrentModule === 'Tv'){
            ...
            if (moduleToPlayVideos === 'rh') {
                videosRHListServer    = getInfoFromServer('getVideosModuleRH'),
                videosRHListLenght    = (videosRHListServer.length)-1;
                // multimediaRHPosition  = 0;
                if (multimediaRHPosition === videosRHListLenght || multimediaRHPosition > videosRHListLenght) {
                    multimediaRHPosition  = 0;
                }else{
                    multimediaRHPosition = multimediaRHPosition+1;
                }
                Debug('Position= '+multimediaRHPosition);
                Debug('moduleToPlayVideos: '+moduleToPlayVideos);
                playMultimedia('samsung', videosRHListServer, multimediaRHPosition);
            }else { 
